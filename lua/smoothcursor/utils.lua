...
sc.set_smoothcursor_highlight = function()
  ...
  vim.api.nvim_set_hl(0, 'SmoothCursor', { bg = nil, fg = '#ffffff', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorRed', { bg = nil, fg = '#cccccc', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorOrange', { bg = nil, fg = '#636363', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorYellow', { bg = nil, fg = '#838584', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorGreen', { bg = nil, fg = '#616161', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorAqua', { bg = nil, fg = '#1c1c1c', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorBlue', { bg = nil, fg = '#111111', default = true })
  vim.api.nvim_set_hl(0, 'SmoothCursorPurple', { bg = nil, fg = '#000000', default = true })
end
